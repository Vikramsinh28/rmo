...
const inputStyles = tv({
  base: [
    ...
    // file
    [
      'file:-my-2 file:-ml-2.5 file:cursor-pointer file:rounded-l-[5px] file:rounded-r-none file:border-0 file:px-3 file:py-2 file:outline-hidden focus:outline-hidden disabled:pointer-events-none disabled:[&::file-selector-button]:pointer-events-none',
      'file:border-solid file:border-border file:bg-background-light file:text-text-muted file:hover:bg-background-dark disabled:[&::file-selector-button]:border-border-muted',
      'file:[border-inline-end-width:1px] file:[margin-inline-end:0.75rem]',
      'disabled:[&::file-selector-button]:bg-background-light disabled:[&::file-selector-button]:text-text-muted',
    ],
    // focus
    focusInput,
    // invalid (optional)
